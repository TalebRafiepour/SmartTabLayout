...
class SmartTabStrip(context: Context, attrs: AttributeSet?) : LinearLayout(context) {
    ...
    private var indicationInterpolator: SmartTabIndicationInterpolator? = null
    ...
    init {
        ...
        val indicatorColors = if (indicatorColorsId == View.NO_ID)
            intArrayOf(indicatorColor)
        else
            resources.getIntArray(indicatorColorsId)

        val dividerColors = if (dividerColorsId == View.NO_ID)
            intArrayOf(dividerColor)
        else
            resources.getIntArray(dividerColorsId)
        ...
        this.isIndicatorAlwaysInCenter = indicatorAlwaysInCenter
        ...
        this.indicatorPaint = Paint(Paint.ANTI_ALIAS_FLAG)
        this.indicatorCornerRadius = indicatorCornerRadius
        this.indicatorGravity = indicatorGravity

        this.dividerHeight = DEFAULT_DIVIDER_HEIGHT
        this.dividerPaint = Paint(Paint.ANTI_ALIAS_FLAG)
        this.dividerPaint.strokeWidth = dividerThickness.toFloat()
    ...
    private class SimpleTabColorizer : SmartTabLayout.TabColorizer {
        ...
        private var dividerColors: IntArray? = null
